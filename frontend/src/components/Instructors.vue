                             ...
                             <b-card-body>
                                 ...
                                 >
                                     ...
                                     <template v-slot:cell(id)="data">
                                         <b-button variant="link" :href="'https://mailjob.amocrm.ru/leads/detail/'+data.value" target="_blank">{{data.value || 'Нет'}}</b-button>
                                     </template>
                                     <template v-slot:cell(id)="data">
                                         <b-button variant="link" :href="'https://mailjob.amocrm.ru/leads/detail/'+data.value" target="_blank">{{data.value || 'Нет'}}</b-button>
                                     </template>
                                     <template v-slot:cell(dateFinished)="data">
